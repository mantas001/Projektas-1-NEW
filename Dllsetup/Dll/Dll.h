...
protected:
    ...
    Zmogus(const string& vard, const string& pav)
        : vard_(vard), pav_(pav) {}
public:
    virtual ~Zmogus() = default;
};

class DLL_API Student_class : public Zmogus {
private:
...
public:
    ...
    friend DLL_API istream& operator>>(istream& is, Student_class& student);
    friend DLL_API ostream& operator<<(ostream& os, const Student_class& student);
